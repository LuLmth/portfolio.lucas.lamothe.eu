...
const Contact = (_) => {
  ...
  return (
    <div id="contact" className="Contact">
      <div className="container mx-auto lg:my-14">
        <div className="Contact-title mb-10 lg:mb-16 text-center transition duration-1000 ease-in-out transform hover:scale-95">
          <h2 className="text-2xl lg:text-4xl font-bold">Contact 📭</h2>
        </div>
        <div className="Contact-form px-2 lg:px-0">
          <form className="max-w-xl mx-auto" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="shadow appearance-none block w-full text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white"
                id="grid-email"
                type="text"
            ...
            <div className="mt-8">
              <button
                type="submit"
                className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 w-full border border-blue-500 hover:border-transparent rounded"
              >
                Confirmer
              </button>
            </div>
