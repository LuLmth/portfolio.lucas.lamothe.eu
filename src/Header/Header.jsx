                        ...
                        <div className="relative flex items-center justify-between h-16">
                            ...
                            <div className="hidden sm:block sm:ml-6">
                                <div className="flex space-x-10 items-center pr-2">
                                    <a className="social-button" href="https://www.linkedin.com/in/lucas-lamothe/" target="_blank" rel="noreferrer">
                                        <span className="sr-only">LinkedIn</span>
                                        <span className="flex flex-row items-center justify-center">
                                            <svg className={"fill-current text-blue-500 " + transitionHover} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                                            <span className="social-button-text text-base pl-3">LinkedIn</span>
                                        </span>
                                    </a>
                                    <a className="social-button" href="https://github.com/LucasLamothe" target="_blank" rel="noreferrer">
                                        ...
                                        <span className="flex flex-row items-center justify-center">
                                            ...
                                            <span className="social-button-text text-base pl-3">Github</span>
                                        </span>
                                    </a>
                                    <a className="social-button" href="https://www.malt.fr/profile/lucaslamothe" target="_blank" rel="noreferrer">
                                        ...
                                        <span className="flex flex-row items-center justify-center">
                                            ...
                                            <span className="social-button-text text-base pl-3">Malt</span>
                                        </span>
                                    </a>
                                </div>
                            </div>
